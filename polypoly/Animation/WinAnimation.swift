...
import Foundation
import SpriteKit
class WinAnimation: SKNode, AnimationProtocol {
    
    let folderName = WinFolder
...
//        let wait = SKAction.wait(forDuration: 0.2)
        ...
        let backgroundImage = SKTexture(imageNamed: "win")
